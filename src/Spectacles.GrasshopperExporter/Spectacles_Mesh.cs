...
{
    public class Spectacles_Mesh : GH_Component
    {
        /// <summary>
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (material.Type != SpectaclesMaterialType.Mesh)
            {
            ...
            Element e = new Element(outJSON, SpectaclesElementType.Mesh, material, layer);
